...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        help="Minimum amount of pay per night to drop outliers",  ## INSERT DESCRIPTION HERE,
        required=True
    )
    ...
    parser.add_argument(
        "--max_price", 
        type=float,## INSERT TYPE HERE: str, float or int,
        help="Maximum amount of pay per night to drop outliers",  ## INSERT DESCRIPTION HERE,
        required=True
    )
